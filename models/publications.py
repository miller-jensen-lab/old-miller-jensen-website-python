...
publications = [
    ...
    {
        'title' : 'Quantitative Evaluation and Optimization of Co-drugging to Improve Anti-HIV Latency Therapy',
    ...
    },
    {
        ...
        'authors' : 'Xue Q., Lu Y., Eisele M.R., Sulistijo E.S., Khan N, Fan R, Miller-Jensen K.',
        'year' : 2015,
    ...
    {
        'title' : 'A passive-flow microfluidic device for imaging latent HIV activation dynamics in single T cells',
    ...
    {
        'title' : '"Pop-slide" patterning: rapid fabrication of microstructured PDMS gasket slides for biological applications',
        'authors' : 'Ramji R., Wong V.C., Chavali A.K., Gearhart L.M., Miller-Jensen K.',
